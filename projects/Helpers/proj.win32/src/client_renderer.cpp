...
namespace {
	...
	class ClientRenderDelegate : public SimpleApp::RenderDelegate {
	public:
		ClientRenderDelegate()
			: last_node_is_editable_(false) {
		}

		virtual void OnWebKitInitialized(CefRefPtr<SimpleApp> app) OVERRIDE{
...
void CreateRenderDelegates(SimpleApp::RenderDelegateSet& delegates) {
